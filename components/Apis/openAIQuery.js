const queryOpenAI = async () => {
  try {
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      method: "POST",
      headers: {
        Authorization: `Bearer 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`,
        ...
        messages: [
          {
            role: "user",
            content:
              "Jest osoba, które obniżyło się tętno praktycznie do 0, co robić w takiej sytuacji? Wylistuj mi w punktach zadanie co robić, maksymalnie 350 znaków. Nie dodawaj nic poza punktami.",
          },
        ],
      }),
    });
